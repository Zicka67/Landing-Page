            ...
            <div class="left">
                ...
                <div class="form-flex">
                    <form action="save-email.php" method="post" id="form">
                        <input class="large-button button-background" type="text" name="email" id="email"
                            placeholder="Enter your Email">
                        <input class="small-button button-background" type="submit" value="SUBSCRIBE">
                </div>
...
<input type="button" value="SUBSCRIBE">
            ...
            foreach ($store as $product) {
                ...
                <div class="card">
                    <div class="<?= $promoClass ?>">
                        <!-- On ajoute la classe $promoClass en fonction de si la promo est disponible ou non. Cette classe sera utilisée pour afficher la promo css.-->
                    ...
                    </h3> <!-- <?= ucFirst($product['name']); ?> = echo, ici affiche le name du product -->

                    <!-- //Ajout de la couleur rouge pour le prix si la card est en promo -->
                    <div class="flex-dollars">
                        <i class="fa-regular fa-dollar-sign <?php if ($product['sale'] > 0) {
                            echo 'sale';
                        } ?>" style="margin-top: 20px;"></i>
                        <!-- <p><span class="<?php if ($product['sale'] > 0) {
                            echo 'sale';
                        } ?>"><?= ucFirst($product['price']); ?></span>/month</p> -->
                        <p>
                            <?php
                            $price = $product['price'];
                    ...
                    <div class="flex-capacity">
                        <div class="flex">
                            ...
                            <h3>
                                <?= ucFirst($product['bandwidth']); ?> Mbps
                            </h3>
                        </div>
                        <div class="flex">
                        ...
                        <div class="flex">
                            ...
                            <h3>
                                <?= ucFirst($product['fees']); ?>
                            </h3>
                        </div>
                    </div>
                    <div class="price-button2 button-background">
    ...
    <div id=color>
        ...
        <div class="swap-color">
            <div class="color-button button-changecolor'" data-theme="blue"></div>
            <div class="color-button button-changecolor'" data-theme="red"></div>
            <p>Click me !</p>
        </div>
    </div>
    ...
    <script>
        ...
        document.documentElement.style.setProperty('--button-background', themes[selectedTheme]['--button-background']);
        [...document.querySelectorAll('.button-changecolor')].forEach(element => {
            element.addEventListener('click', () => {
                const theme = themes[element.dataset.theme];
                for (var variable in theme) {
                    document.documentElement.style.setProperty(variable, theme[variable]);
